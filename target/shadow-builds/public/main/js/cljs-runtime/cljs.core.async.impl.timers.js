...
var i_19659 = (self__.level + (1));
while(true){
if((i_19659 <= (new_level + (1)))){
(update[i_19659] = self__.header);

var G__19660 = (i_19659 + (1));
i_19659 = G__19660;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_19661 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_19661[i]));
} else {
x__$2.forward.push((((i < links_19661.length))?(links_19661[i]):null));
}

if((i < links_19661.length)){
(links_19661[i] = x__$2);
} else {
links_19661.push(x__$2);
}
...
var i_19665 = (0);
while(true){
if((i_19665 <= self__.level)){
var links_19666 = (update[i_19665]).forward;
if((x__$1 === (((i_19665 < links_19666.length))?(links_19666[i_19665]):null))){
(links_19666[i_19665] = (x__$1.forward[i_19665]));

var G__19667 = (i_19665 + (1));
i_19665 = G__19667;
continue;
} else {
var G__19668 = (i_19665 + (1));
i_19665 = G__19668;
continue;
}
} else {
...
var G__19670 = nx;
var G__19671 = (level__$1 - (1));
x = G__19670;
level__$1 = G__19671;
continue;
} else {
var G__19672 = x;
var G__19673 = (level__$1 - (1));
x = G__19672;
level__$1 = G__19673;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__19676 = nx;
var G__19677 = (level__$1 - (1));
x = G__19676;
level__$1 = G__19677;
continue;
} else {
var G__19680 = x;
var G__19681 = (level__$1 - (1));
x = G__19680;
level__$1 = G__19681;
continue;
}
