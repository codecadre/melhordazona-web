...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20804 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_20804(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_20806 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_20806(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_20814 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_20814(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_20824 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_20824(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20827 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_20827(runtime,input,callback);
}
});
...
shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__20787,callback){
var map__20789 = p__20787;
var map__20789__$1 = cljs.core.__destructure_map(map__20789);
var input = map__20789__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20789__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20789__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
