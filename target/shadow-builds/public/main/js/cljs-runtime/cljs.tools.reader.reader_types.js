...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16782 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16782(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16784 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16784(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16786 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16786(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16791 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16791(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16793 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16793(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16795 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16795(reader);
}
});
...
var G__16838 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__16839 = s.append(c);
c = G__16838;
s = G__16839;
continue;
}
