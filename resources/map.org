...
** TODO reorganize file structure and take care of https://passaprimeira.xyz/secrets.edn

/public/
       /.htaccess
       /index.clj
       /shadown.edn ;; adds ../src as source
/src/ ;; all other namespaces
/secret.edn

** TODO cache busting
** TODO bring some of the metatags from my personal blog and review existing ones
** TODO schools form
** TODO runs google checklist
** TODO Update melhor da zona with 2021 data
...
** DONE chat box
*** DONE get pod into project
:LOGBOOK:
CLOCK: [2023-05-27 Sat 16:12]--[2023-05-27 Sat 17:11] =>  0:59
CLOCK: [2023-05-27 Sat 10:11]--[2023-05-27 Sat 16:12] =>  6:01
:END:

- [X] create lib folder
- [X] download it
- [X] make sure you're running babashka 0.8
- [X] add it to bb.edn
- [X] check if it work in repl
- [X] write a parser for the qs
- [X] check if it works in docker/hook it up to the online form
- [ ] check if it works in shared host

*** DONE reset password
:LOGBOOK:
CLOCK: [2023-05-29 Mon 14:52]--[2023-05-29 Mon 15:41] =>  0:49
:END:

*** DONE update nav to include contact form
:LOGBOOK:
CLOCK: [2023-05-29 Mon 15:43]--[2023-05-29 Mon 17:33] =>  1:50
:END:
*** DONE label year
*** DONE style error msgs and success msgs
*** DONE size of the box
*** DONE border styles



* DONE 3rd iteration - after release
